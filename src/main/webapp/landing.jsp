...
<head>
    ...
    <style>
        ...
        .body_wrapper{
            background-image: url('images/bg-diski.jpg');
                    ...
                    <div class="col-md-7 col-lg-6 col-xl-6">
                        <div class="left_content">
                            <div class="cusform">
                                ...
                                <h2>Welcome to <b>Diski Chat</b></h2>
                                <h4>Watch unlimited! cool videos</h4>
                                <form method="POST" action="Login">
                                <div class="form-group mb-3">
                                    <label for="">ENTER YOUR NUMBER AND JOIN Games</label>
